...
func (p *DataGiftPrize) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx,"DataGiftPrize"); err != nil {
...
func (p *DataGiftPrize) writeField3(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin(ctx,"Img", thrift.STRING, 3); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:Img: ", p), err) }
  if err := oprot.WriteString(ctx,string(p.Img)); err != nil {
...
func (p *DataGiftPrize) writeField4(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin(ctx,"Displayorder", thrift.I64, 4); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:Displayorder: ", p), err) }
  if err := oprot.WriteI64(ctx,int64(p.Displayorder)); err != nil {
...
func (p *DataGiftPrize) writeField5(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin(ctx,"Gtype", thrift.I64, 5); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:Gtype: ", p), err) }
  if err := oprot.WriteI64(ctx,int64(p.Gtype)); err != nil {
...
func (p *DataGiftPrize) writeField6(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin(ctx,"Gdata", thrift.STRING, 6); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:Gdata: ", p), err) }
  if err := oprot.WriteString(ctx,string(p.Gdata)); err != nil {
...
func (p *DataResult_) writeField3(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin(ctx,"Gift", thrift.STRUCT, 3); err != nil {
...
func (p *LuckyServiceClient) DoLucky(ctx context.Context, uid int64, username string, ip string, now int64, app string, sign string) (r *DataResult_, err error) {
  ...
  if _, err = p.c.Call(ctx, "DoLucky", &_args0, &_result1); err != nil {
    return
  }
...
func (p *LuckyServiceClient) MyPrizeList(ctx context.Context, uid int64, username string, ip string, now int64, app string, sign string) (r []*DataGiftPrize, err error) {
  ...
  if _, err = p.c.Call(ctx, "MyPrizeList", &_args2, &_result3); err != nil {
    return
  }
...
func (p *LuckyServiceProcessor) Process(ctx context.Context, iprot, oprot thrift.TProtocol) (success bool, err error) {
...
func (p *luckyServiceProcessorDoLucky) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if err = thrift.WrapTException(args.Read(ctx,iprot)); err != nil {
    iprot.ReadMessageEnd(ctx)
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
    oprot.WriteMessageBegin(ctx,"DoLucky", thrift.EXCEPTION, seqId)
    x.Write(ctx,oprot)
    oprot.WriteMessageEnd(ctx)
    oprot.Flush(ctx)
    return false, err
...
var retval *DataResult_
  ...
  if err2 = oprot.WriteMessageBegin(ctx,"DoLucky", thrift.REPLY, seqId); err2 != nil {
...
func (p *luckyServiceProcessorMyPrizeList) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if err1 := args.Read(ctx,iprot); err1 != nil {
    iprot.ReadMessageEnd(ctx)
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
    oprot.WriteMessageBegin(ctx,"MyPrizeList", thrift.EXCEPTION, seqId)
    x.Write(ctx,oprot)
    oprot.WriteMessageEnd(ctx)
    oprot.Flush(ctx)
    return false, thrift.WrapTException(err1)
  }
...
var retval []*DataGiftPrize
  ...
  if err2 = oprot.WriteMessageBegin(ctx,"MyPrizeList", thrift.REPLY, seqId); err2 != nil {
    err = thrift.WrapTException(err2)
  }
  if err2 = result.Write(ctx,oprot); err == nil && err2 != nil {
    err = thrift.WrapTException(err2)
...
//func (p *LuckyServiceDoLuckyArgs) Read(ctx context.Context, iprot thrift.TProtocol) thrift.TException {
//  if _, err := iprot.ReadStructBegin(ctx); err != nil {
//    return thrift.WrapTException(err)
//  }
//
//
//  for {
...
func (p *LuckyServiceDoLuckyArgs) Read(ctx context.Context, iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.WrapTException(err)
  }
...
func (p *LuckyServiceDoLuckyArgs) Write(ctx context.Context, oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx,"DoLucky_args"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(oprot); err != nil { return err }
    if err := p.writeField2(oprot); err != nil { return err }
...
func (p *LuckyServiceDoLuckyArgs) writeField4(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin(ctx,"now", thrift.I64, 4); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:now: ", p), err) }
  if err := oprot.WriteI64(ctx,int64(p.Now)); err != nil {
...
func (p *LuckyServiceDoLuckyArgs) writeField5(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin(ctx,"app", thrift.STRING, 5); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:app: ", p), err) }
  if err := oprot.WriteString(ctx,string(p.App)); err != nil {
...
func (p *LuckyServiceDoLuckyResult) Read(ctx context.Context, iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *LuckyServiceDoLuckyResult) Write(ctx context.Context, oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx,"DoLucky_result"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
...
func (p *LuckyServiceMyPrizeListArgs) Read(ctx context.Context,iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *LuckyServiceMyPrizeListArgs) Write(ctx context.Context,oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx,"MyPrizeList_args"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(oprot); err != nil { return err }
    if err := p.writeField2(oprot); err != nil { return err }
...
func (p *LuckyServiceMyPrizeListResult) Read(ctx context.Context,iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *LuckyServiceMyPrizeListResult) Write(ctx context.Context,oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx,"MyPrizeList_result"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField0(oprot); err != nil { return err }
  }
